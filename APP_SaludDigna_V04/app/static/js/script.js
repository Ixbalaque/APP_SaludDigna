...
function Actualizar_DataUser( key ) {
    ...
    .then(data => {
        ...
        document.getElementById('nombre_R').value     = data.nombre;
        document.getElementById('usuario_R').value    = data.usuario;
        document.getElementById('correo_R').value     = data.correo;
        document.getElementById('nombre_InUsr').innerHTML = 'Bienvenido, ' + data.usuario;
    })
    .catch(error => {
